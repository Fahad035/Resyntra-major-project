const HeroHeading = () => {
    return (
        <>
            <h1 className="max-w-5xl text-center text-5xl font-extrabold leading-tight tracking-tight text-foreground lg:text-7xl">
            ...
            <p className="mt-8 max-w-3xl text-center text-lg leading-8 text-muted lg:text-xl">
