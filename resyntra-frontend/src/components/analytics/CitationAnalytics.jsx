                    ...
                    <div className="grid gap-8 border-t border-border p-10 lg:grid-cols-2">
                        ...
                        <div className="rounded-3xl border border-border bg-background/60 p-8">
                            ...
                            <p className="mt-2 text-muted">
                                Publications and citation impact over the past five years.
                            </p>

                            <div className="mt-10 flex h-72 items-end justify-around rounded-2xl border border-border bg-background/40 p-6">
                                ...
                                {timeline.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <motion.div
                                            ...
                                            className="relative w-12 rounded-t-xl bg-linear-to-t from-cyan-500 via-sky-500 to-violet-500 shadow-[0_0_25px_rgba(6,182,212,.35)]"
                                        >

                                            <span className="absolute -top-8 left-1/2 -translate-x-1/2 text-xs font-semibold text-cyan-400">
                                                {item.value}%
                                            </span>
